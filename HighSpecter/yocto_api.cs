/*********************************************************************
 *
 * $Id: yocto_api.cs 18060 2014-10-15 09:30:35Z seb $
 *
...
public class YAPI
{
    ...
    public const string YOCTO_API_BUILD_NO = "18176";
...
// Yoctopuce error codes, used by default as function return value
    ...
    [DllImport("yapi.dll", EntryPoint = "yapiGetBootloadersDevs", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    internal extern static YRETCODE _yapiGetBootloadersDevs32(StringBuilder serials, int maxNbSerial, ref int totalBootladers, StringBuilder errmsg);
    [DllImport("amd64\\yapi.dll", EntryPoint = "yapiGetBootloadersDevs", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    internal extern static YRETCODE _yapiGetBootloadersDevs64(StringBuilder serials, int maxNbSerial, ref int totalBootladers, StringBuilder errmsg);
    internal static YRETCODE _yapiGetBootloadersDevs(StringBuilder serials, int maxNbSerial, ref int totalBootladers, StringBuilder errmsg) {
        if (IntPtr.Size == 4) {
